...
/**
 * created by lxx at 2020/4/7 4:18
 * 描述:
 */
public class BaseFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    public BaseFragmentPagerAdapter(FragmentManager fm, List<Fragment> fragmentList, List<String> titles) {
        super(fm);
        this.titles = titles;
     ...
     * @param newFragment 新Fragment
     */
    public void replaceFragment(int position, Fragment newFragment,List<String> titles) {
