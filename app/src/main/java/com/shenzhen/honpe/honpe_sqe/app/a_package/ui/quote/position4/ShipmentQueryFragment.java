package com.shenzhen.honpe.honpe_sqe.app.a_package.ui.quote.position4;
 ...
 * Description:出货查询
 */
public class ShipmentQueryFragment extends BaseBackFragment {
    ...
    public static ShipmentQueryFragment newInstance(QuickMultipleEntity entity) {
        ShipmentQueryFragment fragment = new ShipmentQueryFragment();
    ...
    private void initData() {
        ...
        strWhere = "AND T.出货时间>='" + firstDay + "' AND T.出货时间<='" + lastDay + "'";
        if (personEntity !=null)
        EasyHttp.post(Constants.URL + "ShipmentInquiryList")
                .retryCount(0)
