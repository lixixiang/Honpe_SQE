...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.grey_dark));
        ...
        mTvTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, Utils.getFontSize(25));
        ...
        mTvUnreadCount.setBackgroundResource(R.drawable.tips_dot);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.grey_dark));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.grey_dark));
        }
    }
