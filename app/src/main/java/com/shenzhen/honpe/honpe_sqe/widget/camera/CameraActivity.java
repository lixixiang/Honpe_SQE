package com.shenzhen.honpe.honpe_sqe.widget.camera;
...
public class CameraActivity extends Activity implements View.OnClickListener {
     ...
     * 拍摄类型-横版组织机构证书
     */
    public final static int TYPE_ORGANIZATION_LANDSCAPE = 5;
    /**
     * 拍摄类型-横版税务登记证书
     */
    public final static int TYPE_TAX_CERTIFICATE = 6;
    /**
     * 对公银行
      */
    public final static int TYPE_BANK = 7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (type == TYPE_COMPANY_PORTRAIT) {
            ...
            containerView.setLayoutParams(containerParams);
            cropView.setLayoutParams(cropParams);
        } else if (type == TYPE_ORGANIZATION_LANDSCAPE) {
            float height = (int) (screenMinSize * 0.8);
            float width = (int) (height * 43.0f / 30.0f);
            LinearLayout.LayoutParams containerParams = new LinearLayout.LayoutParams((int) width, ViewGroup.LayoutParams.MATCH_PARENT);
            LinearLayout.LayoutParams cropParams = new LinearLayout.LayoutParams((int) width, (int) height);
            containerView.setLayoutParams(containerParams);
            cropView.setLayoutParams(cropParams);
        } else if (type == TYPE_TAX_CERTIFICATE) {
            float height = (int) (screenMinSize * 0.8);
            float width = (int) (height * 43.0f / 30.0f);
            LinearLayout.LayoutParams containerParams = new LinearLayout.LayoutParams((int) width, ViewGroup.LayoutParams.MATCH_PARENT);
            LinearLayout.LayoutParams cropParams = new LinearLayout.LayoutParams((int) width, (int) height);
        ...
        switch (type) {
            ...
            case TYPE_COMPANY_LANDSCAPE:
                ...
                break;
            case TYPE_ORGANIZATION_LANDSCAPE:
                cropView.setImageResource(R.mipmap.camera_organization_landscape);
                break;
            case TYPE_TAX_CERTIFICATE:
                cropView.setImageResource(R.mipmap.camera_organization_landscape);
                break;
            case TYPE_BANK:
                cropView.setImageResource(R.mipmap.camera_organization_landscape);
    ...
    private File getOriginalFile() {
        switch (type) {
            ...
            case TYPE_ORGANIZATION_LANDSCAPE:
                return new File(getExternalCacheDir(), "organizationInfo.jpg");
            case TYPE_TAX_CERTIFICATE:
                return new File(getExternalCacheDir(), "taxCertificateInfo.jpg");
            case TYPE_BANK:
                return new  File(getExternalCacheDir(), "bank.jpg");
        }
    ...
    private File getCropFile() {
        switch (type) {
            ...
            case TYPE_ORGANIZATION_LANDSCAPE:
                return new File(getExternalCacheDir(), "organizationInfoCrop.jpg");
            case TYPE_TAX_CERTIFICATE:
                return new File(getExternalCacheDir(), "taxCertificateInfoCrop.jpg");
            case TYPE_BANK:
                return new  File(getExternalCacheDir(), "bank.jpg");
        }
