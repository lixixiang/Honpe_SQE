package com.shenzhen.honpe.honpe_sqe.widget.dialog.sms;
...
import com.shenzhen.honpe.honpe_sqe.utils.PrivacyHolder;
...
public class PrivacyDialog extends AlertDialog {
	...
	private RoundTextView rejectTv;
	private RoundTextView acceptTv;
	...
	private void initView() {
		...
		this.acceptTv = (RoundTextView) view.findViewById(DemoResHelper.getIdRes(context, "smsdemo_authorize_dialog_accept_tv"));
		this.rejectTv = (RoundTextView) view.findViewById(DemoResHelper.getIdRes(context, "smsdemo_authorize_dialog_reject_tv"));
