package com.shenzhen.honpe.imagepicker.adapter;
...
import com.shenzhen.honpe.imagepicker.data.ItemType;
...
import com.shenzhen.honpe.imagepicker.view.SquareImageView;
import com.shenzhen.honpe.imagepicker.view.SquareRelativeLayout;
    ...
    private void bindMedia(MediaHolder mediaHolder, MediaFile mediaFile) {
        ...
        if (!TextUtils.isEmpty(imagePath)) {
            ...
            try {
                ...
                Log.d("testImagePath", mediaFile.getPath());
            } catch (Exception e) {
                e.printStackTrace();
            }
